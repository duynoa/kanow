import { IInfoPromotion, IInfoViettelPayPromotion } from '@/types/Cars/IPromotions';
...
interface IOpenDialogViettelPayPromotion {
  openDialogPromotion: boolean;
  isLoadingDataPromotion: boolean;
  dataPromotion: IInfoViettelPayPromotion | null;
  setOpenDialogPromotion: (key: boolean) => void;
  setIsLoadingDataPromotion: (key: boolean) => void;
  setDataPromotion: (dataPromotion: IInfoViettelPayPromotion | null) => void;
}
...
export const useDialogViettelPayPromotion = create<IOpenDialogViettelPayPromotion>((set) => ({
  openDialogPromotion: false,
  dataPromotion: null,
  isLoadingDataPromotion: false,
  setOpenDialogPromotion: (key: boolean) => set((state) => ({ openDialogPromotion: key })),
  setIsLoadingDataPromotion: (key: boolean) => set((state) => ({ isLoadingDataPromotion: key })),
  setDataPromotion: (key: IInfoViettelPayPromotion | null) => set((state) => ({ dataPromotion: key })),
}));

    ...
    return (
        <div className='bg-[#F6F6F8]'>
            <div className='w-full max-w-full bg-white'>
                <div className='flex items-center gap-1 lg:text-start text-center text-4xl font-bold text-[#101010] py-8 custom-container'>
                    <div>Xin chào</div>
                    <div className='capitalize text-[#2FB9BD]'>

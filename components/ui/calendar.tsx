        ...
        <>
            <DayPicker
                ...
                classNames={{
                    ...
                    caption_label: "text-base font-bold mt-4 mb-2 text-[#166A71]",
                    ...
                    day: cn(
                        ...
                        "h-12 w-full p-2 rounded-[2px] font-normal aria-selected:opacity-100"
                    ),
                    ...
                    day_range_start: "bg-[#1EAAB1] aria-selected:hover:bg-[#1EAAB1]/80",
                    day_range_end: "bg-[#1EAAB1] aria-selected:hover:bg-[#1EAAB1]/80",
                    // day_today: "bg-accent text-accent-foreground",
                    day_outside:
                        "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
                    day_disabled: "text-muted-foreground opacity-50",
                    day_range_middle:
                        "bg-[#C2F9F9] aria-selected:text-[#2FB9BD] aria-selected:hover:bg-[#2FB9BD] aria-selected:hover:text-white cursor-pointer",

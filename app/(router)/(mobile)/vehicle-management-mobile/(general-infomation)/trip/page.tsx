...
export default function VehicleTripManagement(props: Props) {
    ...
    return (
        <BackgroundUiVehicle className="flex flex-col gap-4">
            <h1 className='text-[#3E424E] text-xl uppercase font-bold'>Quản lý chuyến</h1>
            <ScrollArea
            ...
            >
                <div className='flex flex-col gap-4'>
                    {isState.isLoadingCar ?
                        ...
                        :
                        isState.dataTrips?.length > 0 ?
                            isState.dataTrips.map((e: any, index: number) => {
                                return (
                                        ...
                                        <div className="flex md:flex-row flex-col md:gap-0 gap-6 items-center justify-between md:p-8 p-4">
                                            <div className="flex flex-col gap-6 md:w-[75%] w-full md:order-none order-2">
                                                <div className="space-x-2">
                                                    <span className='text-[#8C93A3] font-medium text-base leading-4'>
                                                        Bắt đầu:
                                                    </span>
                                                    <span className='text-[#3E424E] font-medium text-base leading-5'>
                                                ...
                                                <div className="space-x-2">
                                                    ...
                                                    <span className='text-[#2FB9BD] font-[700] lg:text-xl text-lg leading-5'>
                                            ...
                                            <div className="flex md:flex-col flex-row items-center gap-2 md:w-[25%] w-full">
                                                ...
                                                <h1 className="text-center uppercase text-[#2FB9BD] font-[700] text-base">{e.user?.name}</h1>
                                            </div>
                                        </div>
                                        <div className="flex md:flex-row items-center justify-between md:px-8 px-4 py-4">
                                            <div className="md:w-[75%] w-full">
                                                <div
                                                    ...
                                                    className="py-2 px-4 w-fit rounded-full text-base text-white font-semibold "
                                                >
                                                    {e.status.name}
                                                </div>
                                            </div>
                                            <h1 className='text-[#3E424E] font-medium text-base leading-5  md:w-[25%] w-full text-center'>
                                                <span className="capitalize px-1">
                                                    {moment(e.time).fromNow().split(' ').slice(0, 1).join(' ')}
                                                </span>
                                                <span>

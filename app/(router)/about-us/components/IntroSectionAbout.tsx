    ...
    return (
        <div className='pt-4 w-full'>
            <div className='custom-container flex flex-col items-center justify-center gap-2'>
                ...
                <div className='3xl:text-base text-sm text-[#585F71] font-normal max-w-[50%] text-center'>
            ...
            >
                {
                    imageSlider.map((item, index) => (
                        <div key={item.id} className={`${index % 2 === 0 ? "w-[600px] md:h-[400px] h-full" : "w-[300px] md:h-[400px] h-full"} px-2`}>
                            <Image
                                alt='image'
                                src={`${item.image}`}
                                width={1920}
            ...
            <div className='bg-[#F1FCFC]'>
                <div className='custom-container py-20 grid grid-cols-5 gap-8'>
                    <div className='col-span-2 flex flex-col gap-2'>
                        ...
                        <div className='3xl:text-base xl:text-sm md:text-xs text-sm text-[#8C93A3] font-medium max-w-[75%]'>
                    ...
                    <div className='col-span-1 space-y-6'>
                        <div className={`bg-[#14868E] group-hover:scale-105 duration-300 transition-colors 3xl:text-lg text-base text-white xl:size-14 lg:size-12 size-10 flex items-center justify-center rounded-full`}>
                            <Image
                                width={80}
                                height={80}
                                src={"/icon/about/icon_security_user.png"}
                                className='xl:size-7 lg:size-6 size-5 object-contain'
                                alt="icon"
                            />
                        </div>
                    ...
                    <div className='col-span-1 space-y-6'>
                        <div className={`bg-[#FF9900] group-hover:scale-105 duration-300 transition-colors 3xl:text-lg text-base text-white xl:size-14 lg:size-12 size-10 flex items-center justify-center rounded-full`}>
                            <Image
                                width={80}
                                height={80}
                    ...
                    <div className='col-span-1 space-y-6'>
                        <div className={`bg-[#383A43] group-hover:scale-105 duration-300 transition-colors 3xl:text-lg text-base text-white xl:size-14 lg:size-12 size-10 flex items-center justify-center rounded-full`}>
                            <Image
                                width={80}
                                height={80}

        ...
        <div className="flex flex-col gap-6">
            <div className='flex flex-col gap-2'>
                <div className='flex items-center md:gap-4 gap-2'>
                    <h1 className='text-[#3E424E] lg:text-2xl text-xl font-semibold '>Hợp đồng mẫu</h1>
                </div>
            </div>
            <div className="flex flex-col gap-2">
                <RiFileCloudLine size={150} className="text-[#1EAAB1] mx-auto" />
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-8">
                <Link
                    ...
                    className="flex flex-col items-center justify-center  ml-auto gap-5  shadow bg-gray-100 hover:bg-gray-200 transition-all duration-200 ease-linear w-fit p-4 rounded-xl cursor-pointer">
                ...
                <Link
                    ...
                    className="flex flex-col items-center justify-center  mr-auto gap-5  shadow bg-gray-100 hover:bg-gray-200 transition-all duration-200 ease-linear w-fit p-4 rounded-xl cursor-pointer">

    ...
    return (
        <div className='custom-container flex flex-col gap-8 xl:py-10 py-6'>
            ...
            <div className='grid grid-cols-3 3xl:gap-8 xl:gap-6 gap-4 w-full h-full'>
                {dataCarRelated?.length > 0 && (
                    <div className='w-full lg:col-span-2 col-span-3 3xl:h-[532px] 2xl:h-[480px] xxl:h-[480px] xl:h-[464px] lg:h-[416px] md:h-[320px] h-[200px]'>
                        <Link href={`/news-events/${dataCarRelated[0].id}?${ConvertToSlug(dataCarRelated[0]?.title)}`} className='relative group'>
                            <div className='relative w-full h-full group overflow-hidden rounded-2xl'>
                                ...
                                <BlurImage
                                    image={dataCarRelated[0].image || '/default/default.png'}
                                    alt="image_card"
                                    width={1200}
                                    height={600}
                            ...
                            <div className='flex flex-col 2xl:gap-4 gap-2 absolute xxl:left-[50px] left-[40px] xxl:top-[50px] top-[40px] 2xl:pr-4 pr-6 z-10'>
                                <div className='lg:text-sm md:text-base text-lg uppercase font-medium font-[inter] text-[#61F7F7] xxl:line-clamp-2 line-clamp-1'>
                                    {dataCarRelated[0].type || ""}
                                </div>
                                ...
                                <div className='3xl:text-base 2xl:text-sm xxl:text-sm xl:text-sm lg:text-sm md:text-sm text-base text-white font-normal xxl:line-clamp-3 line-clamp-2 xl:max-w-[95%] max-w-full'>
                                    {dataCarRelated[0].description || ""}
                                </div>
                            </div>
                            {/* <div className='absolute xxl:left-[50px] left-[40px] xxl:bottom-[50px] bottom-[40px] z-10'>
                                <Button
                                    size="readMore"
                ...
                <div className='w-full lg:col-span-1 col-span-3 grid grid-rows-2 3xl:h-[532px] 2xl:h-[480px] xxl:h-[480px] xl:h-[464px] lg:h-[416px] md:h-[656px] h-[416px] 3xl:gap-8 xl:gap-6 gap-4'>
                    {dataCarRelated?.length > 1 && dataCarRelated?.slice(1, 3)?.map((article, index) => (
                        <Link
                            key={`news-${article.id}`}
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-2 absolute xxl:left-[30px] left-[20px] xxl:top-[30px] top-[20px] 2xl:pr-4 pr-6 z-10'>
                                <div className='lg:text-sm md:text-base text-lg uppercase font-medium font-[inter] text-[#61F7F7] xxl:line-clamp-2 line-clamp-1'>
                                    {article.type || ""}
                                </div>
                                <div className='3xl:text-xl 2xl:text-[17px] xxl:text-[17px] xl:text-base lg:text-base md:text-xl text-xl  text-white font-semibold group-hover:text-white/70 duration-500 transition ease-in-out xxl:line-clamp-2 line-clamp-1'>
                            ...
                            {/* <div className='absolute xxl:left-[30px] left-[20px] xxl:bottom-[30px] bottom-[20px] z-10'>
                                <Button
                                    size="readMore"
                                    className='2xl:px-8 2xl:py-3 xl:px-6 xl:py-3 px-4 py-2 flex items-center gap-2 font-bold text-[#000000] bg-[#9DF2EE] group-hover:bg-[#9DF2EE]/90 group-hover:translate-x-2'
                                >
            ...
            <div className='grid xxl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 3xl:gap-6 gap-4 justify-start h-full w-full'>
                {
                    dataCarRelated.length > 3 && dataCarRelated?.slice(3).map((item) => (
                        <Link
                            key={`news-${item.id}`}
